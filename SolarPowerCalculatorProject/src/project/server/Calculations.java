...
public class Calculations {
	...
	public Calculations(String panelNumber, int numberPanels, String suburb,
		...
		}else if((Math.abs(tilt) <= -0.03457*(this.orientation^2) + 107 - idealTilt)){
			orientationEfficiencyLoss = 0.2;
		}else if((Math.abs(tilt) <= idealTilt - 4)){
			orientationEfficiencyLoss = 0.3;
		}else if((Math.abs(tilt) <= -0.03457*(this.orientation^2) + 117 - idealTilt)){
			orientationEfficiencyLoss = 0.3;
		}else if((Math.abs(tilt) <= idealTilt + 9)){
			orientationEfficiencyLoss = 0.4;
		}else if((Math.abs(tilt) <= -0.03457*(this.orientation^2) + 127 - idealTilt)){
			orientationEfficiencyLoss = 0.4;
		}else if((Math.abs(tilt) <= idealTilt + 22)){
			orientationEfficiencyLoss = 0.5;
		}else if((Math.abs(tilt) <= -0.03457*(this.orientation^2) + 137 - idealTilt)){
			orientationEfficiencyLoss = 0.5;
		}else if((Math.abs(tilt) <= idealTilt + 35)){
			orientationEfficiencyLoss = 0.6;
		}else if((Math.abs(tilt) <= -0.03457*(this.orientation^2) + 147 - idealTilt)){
			orientationEfficiencyLoss = 0.6;
		}else{
